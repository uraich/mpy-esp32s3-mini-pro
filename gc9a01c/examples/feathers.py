...
def color_wheel(position):
    ...
    if position < 85:
        return gc9a01.color565(255 - position * 3, 0, position * 3)

    if position < 170:
        position -= 85
        return gc9a01.color565(0, position * 3, 255 - position * 3)

    position -= 170
    return gc9a01.color565(position * 3, 255 - position * 3, 0)
...
def main():
    ...
    try:
        while True:
            ...
            tft.vline(scroll, 0, height, gc9a01.BLACK)
